      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 space-y-4">
          <Card className="border border-slate-200 bg-white p-4 shadow-sm">
            <h2 className="text-sm font-semibold text-slate-800 mb-4">Phương thức nạp tiền</h2>
            ...
            <div className="mt-8 space-y-4 max-w-sm">
              <div className="space-y-1">
                <label className="block text-[11px] font-semibold text-slate-500">Số tiền cần nạp (VNĐ)</label>
                <div className="relative">
                  <input
                    ...
                    placeholder="50000"
                    className="w-full h-9 pl-3 pr-12 text-xs bg-white border border-slate-200 hover:border-slate-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 rounded-lg outline-none transition-all duration-150 font-bold text-slate-700"
                  />
              ...
              <Button 
                variant="primary" 
                size="sm"
                className="w-full font-bold h-9 text-xs rounded-lg cursor-pointer"
              >
                Tiếp tục nạp tiền
              </Button>
            </div>
        ...
        <div className="space-y-4">
          <Card className="border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <div className="space-y-2">
              <h3 className="text-xs font-bold text-slate-700">Chế độ thử nghiệm</h3>
              <Button 
                variant="secondary" 
                size="sm"
                isDisabled={loading}
                onPress={handleTestDeposit}
                className="w-full font-bold h-9 text-xs rounded-lg cursor-pointer border border-slate-200 bg-white text-slate-700 hover:bg-slate-50"
              >
                {loading && (
