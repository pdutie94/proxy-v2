    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <Button
          ...
          className="cursor-pointer font-bold text-xs h-9 px-3 flex items-center gap-1.5 self-start sm:self-auto rounded-lg bg-blue-600 text-white"
        >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 mt-1">
        ...
        <div className="text-xs text-slate-500 font-semibold">
          Đang hiển thị {filteredLocations.length} vị trí
        </div>
        ...
        <div className="flex items-center gap-2">
          <div className="relative w-full sm:w-56">
            <input
              type="text"
              placeholder="Tìm tên, mã quốc gia..."
              value={queryValue}
              ...
              {filteredLocations.map((loc) => (
                <Table.Row key={loc.id}>
                  ...
                  <Table.Cell className="align-top">
                    <Chip size="sm" variant="soft" color="accent" className="text-xs uppercase">
                      {loc.countryCode}
                    </Chip>
                  </Table.Cell>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      className={`w-full h-9 text-xs bg-white outline-none`}
                    />
                  )}
                />
                {errors.name && (
