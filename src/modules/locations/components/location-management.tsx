  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-end gap-3 mb-4 mt-1">
        ...
        <SearchField 
          name="search"
          aria-label="Tìm tên, mã QG"
          value={queryValue}
          onChange={(value) => setQueryValue(value)}
        >
          <SearchField.Group>
            <SearchField.SearchIcon />
            <SearchField.Input className="w-[200px]" placeholder="Tìm tên, mã QG..." />
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
          <div className="bg-white border border-slate-200 rounded-xl w-full max-w-xl overflow-hidden shadow-lg flex flex-col animate-in fade-in zoom-in-95 duration-150">
            {/* Modal Header */}
